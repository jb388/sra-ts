...
sra.19.01.d <- merge(sra.19.01.09[sra.19.01.09$Year == 2001, ],
                     sra.19.01.09[sra.19.01.09$Year == 2019, ],
                     by = c("PM", "ECO", "PMeco", "lyr_top", "lyr_bot"),
                     suffixes = c("_01", "_19")) 
sra.19.01.d$dd14c_01_19 <- sra.19.01.d$d14c_01 - sra.19.01.d$d14c_19
sra.19.01.d$sd14c_01_19 <- sra.19.01.d$d14c_sd_01 + sra.19.01.d$d14c_sd_19
...
The relative importance of parent material and climate for explaining the variance in $\Delta$^14^C-CO~2~ changes with depth in a similar manner as it does for bulk soil. Climate explains more of the variance in $\Delta$^14^C-CO~2~ at the surface (0-10cm) than does parent material (Table 4). Unlike bulk soil, however, parent material is not significant for $\Delta$^14^C-CO~2~ at the surface at all. Both parent material and climate are significant (*p* < 0.0005) for $\Delta$^14^C-CO~2~ at the 10-20cm depth, but parent material explains more variance than does climate (Table 5). At the deepest depth (20-30cm) climate is no longer a siginficant predictor of $\Delta$^14^C-CO~2~ at all, while parent material is strongly siginficant (*p* = 0.006) (Table 6). 
...
Overall the models explained more variance in respired $\Delta$^14^C-CO~2~ than in bulk soil $\Delta$^14^C. The $\Delta$^14^C-CO~2~ models explained a similar amount of the variance at the 0-10cm and 10-20cm depths (R^2^ of 0.86 and 0.89, respectively), and slightly less at the deepest depth (R^2^ = 0.70).
