...
lapply(split(sra.2001.bulk.df, sra.2001.bulk.df$lyr_bot), function(x) {
  TukeyHSD(aov(d14c ~ PM, x[x$d14c > -200, ]))
})
# ECO
lapply(split(sra.2001.bulk.df, sra.2001.bulk.df$lyr_bot), function(x) {
...
lapply(split(sra.2001.bulk.df, sra.2001.bulk.df$lyr_bot), function(x) {
  TukeyHSD(aov(d14c ~ ECO, x[x$d14c > -200, ]))
})
...
lapply(split(sra.2019.bulk.df, sra.2019.bulk.df$lyr_bot), function(x) {
  if (nrow(x) == 27) TukeyHSD(aov(d14c ~ PM, x[x$d14c > -200, ]))
})
# ECO
lapply(split(sra.2019.bulk.df, sra.2019.bulk.df$lyr_bot), function(x) {
...
lapply(split(sra.2019.bulk.df, sra.2019.bulk.df$lyr_bot), function(x) {
  if (nrow(x) == 27) TukeyHSD(aov(d14c ~ ECO, x[x$d14c > -200, ]))
})
## inc
