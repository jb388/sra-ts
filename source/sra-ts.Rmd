...
# calc atm in 2001, 2009
atm.d14.2001 <- graven[graven$Date == 2001.5, "NHc14"]
atm.fm.2001 <- calc_fm(atm.d14.2001, 2001)
atm.d14.2009 <- graven[graven$Date == 2009.5, "NHc14"]
...
sra.01.09 %>%
  ...
  scale_y_reverse() +
  scale_x_continuous() +    
  scale_color_manual(values = c("andesite" = "blue", 
                                "basalt" = "red", 
                                "granite" = "darkgray")) +
  scale_shape_manual(values = c("warm (2001)" = 15, 
                                "cool (2001)" = 16, 
                                "cold (2001)" = 17,
                                "warm (2009)" = 0, 
                                "cool (2009)" = 1, 
