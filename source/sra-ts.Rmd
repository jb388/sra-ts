...
sra.2019.ls <- lapply(seq_along(sra.2019.ls), function(df) {
  cbind(sra.2019.ls[[df]], mass_kgm2 = mass_pred[[df]])
})
...
# 2019
sra.2019.ls <- cstock.fx(sra.2019.ls, "mass_kgm2", "C")
# 2009
sra.2009.ls <- cstock.fx(sra.2009.ls, "mass_kgm2", "C_pct")
...
save(sra.19.01.inc.df, file = "sra.19.01.inc.df.RData")
# join
